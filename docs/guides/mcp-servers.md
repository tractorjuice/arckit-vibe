...
- **Claude Code** v2.1.280 or later (or **Claude Cowork** desktop app)
...
`claude install` accepts `stable`, `latest`, or a specific version (e.g. `claude install 2.1.280`). If you don't have the `claude` CLI yet, follow the [official Claude Code install guide](https://docs.claude.com/en/docs/claude-code/quickstart) first.
