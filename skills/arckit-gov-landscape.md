...
Before writing, read `${VIBE_EXTENSION_ROOT}/references/quality-checklist.md` and verify all **Common Checks** plus the **GLND** per-type checks pass. Fix any failures before proceeding.
...
- **Templates** — `${VIBE_EXTENSION_ROOT}/templates/gov-landscape-template.md` (override at `.arckit/templates-custom/gov-landscape-template.md`)
