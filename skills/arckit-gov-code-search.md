...
Before writing, read `${VIBE_EXTENSION_ROOT}/references/quality-checklist.md` and verify all **Common Checks** plus the **GCSR** per-type checks pass. Fix any failures before proceeding.
...
- **Templates** — `${VIBE_EXTENSION_ROOT}/templates/gov-code-search-template.md` (override at `.arckit/templates-custom/gov-code-search-template.md`)
