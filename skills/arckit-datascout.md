...
- If not found, read `${VIBE_EXTENSION_ROOT}/templates/datascout-template.md` (default)
...
Before writing the file, read `${VIBE_EXTENSION_ROOT}/references/quality-checklist.md` and verify all **Common Checks** plus the **DSCT** per-type checks pass. Fix any failures before proceeding.
