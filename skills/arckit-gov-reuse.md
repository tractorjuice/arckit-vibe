...
- If not found, read `${VIBE_EXTENSION_ROOT}/templates/gov-reuse-template.md` (default)
...
Before writing, read `${VIBE_EXTENSION_ROOT}/references/quality-checklist.md` and verify all **Common Checks** plus the **GOVR** per-type checks pass. Fix any failures before proceeding.
